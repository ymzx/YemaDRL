    ...
    while total_steps < args.max_train_steps:
        ...
        while not done:
            ...
            if args.policy_distribution == 'Beta':
                action = 2 * (action - 0.5) * args.max_action  # [0,1]->[-max_action, max_action]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--evaluate_steps", type=int, default=int(5e3), help="Evaluate the policy every 'evaluate_freq' steps")
    parser.add_argument("--save_steps", type=int, default=int(3e4), help="Save frequency")
